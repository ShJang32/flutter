...
기준은 2023년 1월 18일 입니다. 참고해주세요

[저는 SDK를 직접 설치하지 않고 니꼬쌤이 추천해주시는 방법을 이용했습니다.]
...
++ 관리자 권한 cmd에선 flutter doctor 실행 잘 되는데
일반 cmd나 git에서 "Unable to find git in your PATH." 등의 오류가 뜨거나 cmd창이 꺼지는 분들은 관리자 cmd에서
" git config --global --add safe.directory '*' "
라고 입력한 뒤에야 일반 cmd에서도 잘 돌아가더라구요.
이거 되야 vscode에서도 flutter실행 잘 되는것같아요. 참고하세용
